...
BOT_TOKEN = environ.get('BOT_TOKEN', "8317688074:AAFfpYjnw_3Fhs_7ccDHKkZ9Q7uU1zipv9M")    # Bot token from @BotFather
...
PICS = (environ.get('PICS', 'https://envs.sh/-_Z.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/-_Z.jpg")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://envs.sh/-_Z.jpg")
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1003297786800').split()] #(make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1003337791341")# Channels for force sub (make sure bot is admin)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003454917075'))  # Notification of sent to your channel
